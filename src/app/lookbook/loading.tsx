    ...
    <main className="min-h-screen bg-[var(--vsc-cream)]">
      ...
      <section className="px-6 md:px-12 lg:px-20 pb-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10">
          <div className="md:col-span-7 aspect-[4/5] md:aspect-square bg-[var(--vsc-gray-200)] animate-pulse" />
          <div className="md:col-span-5 aspect-square bg-[var(--vsc-gray-200)] animate-pulse" />
          <div className="md:col-span-5 aspect-square bg-[var(--vsc-gray-200)] animate-pulse" />
          <div className="md:col-span-7 aspect-[4/5] md:aspect-square bg-[var(--vsc-gray-200)] animate-pulse" />
        </div>
      </section>
