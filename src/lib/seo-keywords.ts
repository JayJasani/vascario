// Common SEO keyword sets shared across all pages
// Central place to manage high-intent, long-tail and brand keywords

export const SEO_KEYWORDS = {
  // PRIMARY: High-volume, high-intent keywords targeting #1 rankings
  primary: [
    // Premium streetwear & brand positioning (global across site)
    ...
    "experimental streetwear India",
    "urban luxury fashion India",
    ...
    // Competitor and discovery keywords (from AI Overview cluster)
    "top premium streetwear brands in India",
    "top 10 premium streetwear brands in India",
    "premium Indian streetwear brands",
    "Indian streetwear brands like Jaywalking",
    "Indian streetwear brands like Huemn",
    "Indian streetwear brands like Almost Gods",
    "Indian streetwear brands like NorBlack NorWhite",
    "Indian streetwear brands like Bluorng",
    "brands like Urban Monkey India",
  ...
  secondary: [
    // Product- and collection-level streetwear keywords
    ...
    // Brand name discovery keywords (competitor / marketplace)
    "Jaywalking streetwear India",
    "Huemn streetwear India",
    "Almost Gods streetwear India",
    "NorBlack NorWhite streetwear India",
    "Bluorng streetwear India",
    "NoughtOne streetwear India",
    "Urban Monkey streetwear India",
    "Capsul streetwear store India",
    "Farak streetwear India",
    "Hiyest streetwear India",
    "House of Koala streetwear India",
    "Khaaki streetwear India",
    "Rabitual streetwear India",
  ],
  ...
  longTail: [
    ...
    // Best/Top + competitor/comparison streetwear keywords (HIGH INTENT)
    "best embroidered clothing India",
    "best luxury streetwear brand India",
    ...
    // Premium embroidery + premium streetwear — full long-tail coverage
    ...
    // Question-style / AI Overview style queries
    "what are the top premium streetwear brands in India",
  ...
  highIntentKeywords: function () {
    return [
      ...this.highIntent,
      ...this.primary.filter(
        (k) => k.includes("buy") || k.includes("shop") || k.includes("best") || k.includes("online"),
      ),
    ]
  },
