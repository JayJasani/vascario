    ...
    return (
        ...
        >
            ...
            <div className="px-4 py-3 border-b-2 border-[#2A2A2A] flex items-center justify-between">
                <div>
                    <span className="font-mono text-[9px] text-[#666] tracking-[0.15em]">
                        ORDER //
                    </span>
                    <span className="font-mono text-[10px] text-[#BAFF00] tracking-[0.1em] ml-1.5">
                    ...
                    >
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-0.5">
                                <span className="font-mono text-[9px] text-[#BAFF00] tracking-[0.1em]">
                                    {item.size}
                                </span>
                                <span className="text-[#2A2A2A]">│</span>
                                <div className="flex items-center gap-1">
                                    <div
                                        className="w-2 h-2 border border-[#2A2A2A]"
                                ...
                                <span className="text-[#2A2A2A]">│</span>
                                <span className="font-mono text-[9px] text-[#666] tracking-[0.1em]">
                                    QTY:{item.quantity}
                                </span>
                            </div>
                        </div>
            ...
            {/* Footer */}
            <div className="px-4 py-3 border-t-2 border-[#2A2A2A] flex items-center justify-between">
                <span className="font-mono text-[9px] text-[#666] tracking-[0.1em]">
                    {createdAt}
                </span>
                <span className="font-mono text-xs text-[#F5F5F0] font-bold tracking-[0.05em]">
                    ₹{totalAmount}
                </span>
            </div>
            ...
            {/* Action buttons */}
            {children && (
                <div className="px-4 py-3 border-t border-[#1A1A1A] flex gap-2 flex-wrap">
                    {children}
                </div>
            )}
        </div>
